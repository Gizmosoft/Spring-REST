...
public class EmployeeController {
	...
	@RequestMapping(value = "emp/controller/getDetailsinPriceRange/{minPlace}--{maxPlace}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<EmployeeBean>> getEmployeeDetailsWithinSalaryRange(@PathVariable("minPlace")double min,@PathVariable("maxPlace") double max) {
		List<EmployeeBean> list = employeeServiceImpl.getEmployeeDetailsWithinSalaryRange(min,max);
